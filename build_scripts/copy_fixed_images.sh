...
# directories ../images and ../images/manual_images.
...
do
  echo "copy $fil"
  cp ../images_warehouse/$fil ../images
done


if [ ! -d ../images/manual_images ]
then
  echo 'Images/manual_images directory does not exist...creating it now.'
  mkdir ../images/manual_images
fi
...
do
  echo "copy $fil"
  cp ../images_warehouse/$fil ../images/manual_images
done
