...
test_that("order_cells works", {
  ...
  expect_equal(max(pseudotime(cds)), 8.700346, tol = 1e-5)
  expect_equal(min(pseudotime(cds)), 0)
  expect_equal(pseudotime(cds)[1], 5.646813e-05, tol = 1e-5)
  cds <- order_cells(cds, root_pr_nodes = c("Y_1", "Y_10"))
  expect_equal(max(pseudotime(cds)), 8.700346, tol = 1e-5)
  expect_equal(min(pseudotime(cds)), 0)
  expect_equal(pseudotime(cds)[1], 5.646813e-05, tol = 1e-5)
  cds <- order_cells(cds, root_cells = "G07_B02_RT_587")
  expect_equal(max(pseudotime(cds)), 11.09045, tol = 1e-5)
  expect_equal(min(pseudotime(cds)), 0)
  expect_equal(pseudotime(cds)[1], 4.23883, tol = 1e-5)
...
test_that("order_cells works 3d", {
  cds <- order_cells(cds, root_pr_nodes = "Y_1")
  expect_equal(max(pseudotime(cds)), 13.2025, tol = 1e-5)
  expect_equal(min(pseudotime(cds)), 0)
  expect_equal(pseudotime(cds)[1], 0.04665275, tol = 1e-5)
  cds <- order_cells(cds, root_pr_nodes = c("Y_1", "Y_10"))
  expect_equal(max(pseudotime(cds)), 12.64457, tol = 1e-5)
  expect_equal(min(pseudotime(cds)), 0)
  expect_equal(pseudotime(cds)[1], 0.04665275, tol = 1e-5)
  cds <- order_cells(cds, root_cells = "G07_B02_RT_587")
  expect_equal(max(pseudotime(cds)), 15.22079, tol = 1e-5)
  expect_equal(min(pseudotime(cds)), 0)
  expect_equal(pseudotime(cds)[1], 2.064947, tol = 1e-5)
  cds <- order_cells(cds, root_cells = c("G07_B02_RT_587", "F06_A01_RT_598"))
  expect_equal(max(pseudotime(cds)), 7.083912, tol = 1e-5)
  expect_equal(min(pseudotime(cds)), 0)
  expect_equal(pseudotime(cds)[1], 2.064947, tol = 1e-5)
})
