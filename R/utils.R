                                ...
                                scale. = FALSE, ...)
{
  ...
  cat( 'checksum: utils.R: sparse_prcomp_irlba: start: irlba::irlba in (args): ', digest::digest( args ), '\n' )
  s <- do.call(irlba::irlba, args=args)
  cat( 'checksum: utils.R: sparse_prcomp_irlba: end: irlba::irlba out (s): ', digest::digest( s ), '\n' )
